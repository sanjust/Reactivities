        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (attendance.IsHost)
                    throw new RestException(System.Net.HttpStatusCode.BadRequest, new { attendance = "You can not remove yourself as host" });
                ...
                throw new Exception("Problem while setting attend");
            }
        }
    }
}
